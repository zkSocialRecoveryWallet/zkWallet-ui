...
const TransferERC20 = () => {
    ...
    async function transferERC20(tokenAddress: string, toAddress: string, tokenAmount: number) { 
      ...
      try {
        const tx = await instance.transferERC20(tokenAddress, toAddress, utils.parseUnits(tokenAmount.toString(), tokenDecimals))
