...
const ApproveERC20 = () => {
    ...
    async function approveERC20(tokenAddress: string, spenderAddress: string, tokenAmount: number) { 
      ...
      try {
        const tx = await instance.approveERC20(tokenAddress, spenderAddress,  utils.parseUnits(tokenAmount.toString(), tokenDecimals))
         console.log(await tx.wait())            
        setLogs(`ERC20 allowed amount ${tokenAmount} for spender ${spenderAddress}`)
            ...
            <CssBaseline />
             <form onSubmit={handleSubmit(onSubmitHandler)} > 
                ...
                <Input                    
                  ...
                  className={`form-control ${errors.spenderAddress ? 'is-invalid' : ''}`}                
                </Input>
                <div className={styles.invalid}>{errors.spenderAddress?.message}</div>
                <Input                    
                  type="float" 
