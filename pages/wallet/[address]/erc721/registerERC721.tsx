...
const RegisterERC721 = () => {
    ...
    useEffect(() => {
      const fetchProvider = async () => {
        ...
        const erc721FacetIntance: any = await new Contract(walletAddress, ERC721ServiceFacetAbi.abi, signer)    
    ...
    async function registerERC721(tokenAddress: string) { 
      const instance: any = await new Contract(walletAddress, ERC721FacetAbi.abi, signer)
