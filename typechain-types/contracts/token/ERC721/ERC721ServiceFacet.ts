...
export interface ERC721ServiceFacetInterface extends utils.Interface {
  functions: {
...
export interface ERC721ServiceFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721ServiceFacetInterface;
