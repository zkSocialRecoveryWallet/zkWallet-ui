...
export interface ERC20ServiceFacetInterface extends utils.Interface {
  functions: {
...
export interface ERC20ServiceFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20ServiceFacetInterface;
