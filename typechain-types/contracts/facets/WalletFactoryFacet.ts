...
export interface WalletFactoryFacetInterface extends utils.Interface {
  functions: {
    ...
    "walletFactoryFacetVersion()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "walletFactoryFacetVersion",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "walletFactoryFacetVersion()",
...
export interface WalletFactoryFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WalletFactoryFacetInterface;
  ...
  functions: {
    ...
    createWallet(
      ...
      verifier: IWalletFactoryInternal.VerifierDTOStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    walletFactoryFacetVersion(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    walletFactoryFacetVersion(overrides?: CallOverrides): Promise<BigNumber>;
