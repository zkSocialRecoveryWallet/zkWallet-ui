...
export interface ISemaphoreFacetInterface extends utils.Interface {
  functions: {
...
export interface ISemaphoreFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISemaphoreFacetInterface;
