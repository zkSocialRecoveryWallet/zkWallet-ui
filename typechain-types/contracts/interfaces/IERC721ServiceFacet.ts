...
export interface IERC721ServiceFacetInterface extends utils.Interface {
  functions: {
...
export interface IERC721ServiceFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC721ServiceFacetInterface;
