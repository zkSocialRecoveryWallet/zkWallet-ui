...
export interface IWalletFactoryFacetInterface extends utils.Interface {
  functions: {
...
export interface IWalletFactoryFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IWalletFactoryFacetInterface;
