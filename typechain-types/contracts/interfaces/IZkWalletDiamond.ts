...
export interface IZkWalletDiamondInterface extends utils.Interface {
  functions: {
...
export interface IZkWalletDiamond extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IZkWalletDiamondInterface;
