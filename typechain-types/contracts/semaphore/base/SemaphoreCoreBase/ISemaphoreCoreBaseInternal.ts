...
export interface ISemaphoreCoreBaseInternalInterface extends utils.Interface {
  functions: {};
...
export interface ISemaphoreCoreBaseInternal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISemaphoreCoreBaseInternalInterface;
