...
export interface SemaphoreCoreBaseInterface extends utils.Interface {
  functions: {};
...
export interface SemaphoreCoreBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SemaphoreCoreBaseInterface;
