...
export interface ISemaphoreCoreBaseInterface extends utils.Interface {
  functions: {};
...
export interface ISemaphoreCoreBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISemaphoreCoreBaseInterface;
