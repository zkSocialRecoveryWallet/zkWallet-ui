...
export interface ISimplicyDiamondInterface extends utils.Interface {
  functions: {
...
export interface ISimplicyDiamond extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISimplicyDiamondInterface;
