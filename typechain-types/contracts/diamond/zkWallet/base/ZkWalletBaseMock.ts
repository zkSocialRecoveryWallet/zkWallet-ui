...
export interface ZkWalletBaseMockInterface extends utils.Interface {
  functions: {
...
export interface ZkWalletBaseMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZkWalletBaseMockInterface;
