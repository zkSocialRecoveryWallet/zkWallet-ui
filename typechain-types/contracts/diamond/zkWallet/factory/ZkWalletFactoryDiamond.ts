...
export interface ZkWalletFactoryDiamondInterface extends utils.Interface {
  functions: {
...
export interface ZkWalletFactoryDiamond extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZkWalletFactoryDiamondInterface;
