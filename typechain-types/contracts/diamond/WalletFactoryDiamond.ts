...
export interface WalletFactoryDiamondInterface extends utils.Interface {
  functions: {
...
export interface WalletFactoryDiamond extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WalletFactoryDiamondInterface;
