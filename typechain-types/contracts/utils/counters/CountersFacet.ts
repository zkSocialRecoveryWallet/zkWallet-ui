...
export interface CountersFacetInterface extends utils.Interface {
  functions: {
    "countersFacetVersion()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "countersFacetVersion",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "countersFacetVersion()",
...
export interface CountersFacet extends BaseContract {
  ...
  functions: {
    countersFacetVersion(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    countersFacetVersion(overrides?: CallOverrides): Promise<BigNumber>;
